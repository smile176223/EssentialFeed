...
final class RemoteLoaderTests: XCTestCase {
    ...
    private func expect(_ sut: RemoteLoader, toCompleteWith expectResult: RemoteLoader.Result, when action: () -> Void, file: StaticString = #filePath, line: UInt = #line) {
        ...
        sut.load { receivedResult in
            ...
            case let (.failure(receivedError as RemoteLoader.Error), .failure(expectError as RemoteLoader .Error)):
