...
final class RemoteLoaderTests: XCTestCase {
    ...
    private func expect(_ sut: RemoteLoader<String>, toCompleteWith expectResult: RemoteLoader<String>.Result, when action: () -> Void, file: StaticString = #filePath, line: UInt = #line) {
        ...
        sut.load { receivedResult in
            ...
            case let (.failure(receivedError as RemoteLoader<String>.Error), .failure(expectError as RemoteLoader<String> .Error)):
