...
class LoadImageCommentsFromRemoteUseCase: XCTestCase {
    ...
    private func expect(_ sut: RemoteImageCommentsLoader, toCompleteWith expectResult: RemoteImageCommentsLoader.Result, when action: () -> Void, file: StaticString = #filePath, line: UInt = #line) {
        ...
        sut.load { receivedResult in
            ...
            case let (.failure(receivedError as RemoteImageCommentsLoader.Error), .failure(expectError as RemoteImageCommentsLoader.Error)):
