...
final class FeedViewControllerTests: XCTestCase {
    ...
    func test_loadFeedCompletion_deosNotAlterCurrentRenderingStateOnError() {
    ...
    func test_feedImageViewLoadingIndicator_isVisibleWhileLoadingImage() {
        ...
        XCTAssertEqual(view0?.isShowingImageLoadingIndicator, false, "Expected no loading indicator for first once first image loading completes successfully")
    ...
    func test_feedImageView_preloadsImageURLWhenNearVisible() {
        ...
        sut.loadViewIfNeeded()
        loader.completeFeedLoading(with: [image0, image1])
        XCTAssertEqual(loader.loadedImageURLs, [], "Expected no image URL requests until images is near visible")
